...
func testRolesExists(t *testing.T) {
	...
	e, err := RoleExists(ctx, tx, o.RoleID)
	if err != nil {
...
func testRolesFind(t *testing.T) {
	...
	roleFound, err := FindRole(ctx, tx, o.RoleID)
	if err != nil {
		t.Error(err)
	}
...
func testRoleToManyPolicies(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	_, err = tx.Exec("insert into \"role_policies\" (\"role_id\", \"policy_id\") values ($1, $2)", a.RoleID, b.PolicyID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"role_policies\" (\"role_id\", \"policy_id\") values ($1, $2)", a.RoleID, c.PolicyID)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := RoleSlice{&a}
	if err = a.L.LoadPolicies(ctx, tx, false, (*[]*Role)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testRoleToManyUsers(t *testing.T) {
	...
	_, err = tx.Exec("insert into \"user_roles\" (\"role_id\", \"user_id\") values ($1, $2)", a.RoleID, b.UserID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"user_roles\" (\"role_id\", \"user_id\") values ($1, $2)", a.RoleID, c.UserID)
	if err != nil {
		t.Fatal(err)
	}
...
func testRoleToManyAddOpPolicies(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if first.R.Roles[0] != &a {
			t.Error("relationship was not added properly to the slice")
		}
		if second.R.Roles[0] != &a {
			t.Error("relationship was not added properly to the slice")
		}
...
func testRoleToManySetOpPolicies(t *testing.T) {
	var err error
...
func testRoleToManyRemoveOpPolicies(t *testing.T) {
	var err error
...
func testRoleToOneOrgUsingOrg(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = local.L.LoadOrg(ctx, tx, false, (*[]*Role)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Org == nil {
...
func testRoleToOneSetOpOrgUsingOrg(t *testing.T) {
	var err error
...
var (
	roleDBTypes = map[string]string{`RoleID`: `integer`, `Name`: `text`, `OrgID`: `integer`}
	_           = bytes.MinRead
)
