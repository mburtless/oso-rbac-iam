...
var (
	roleAllColumns            = []string{"role_id", "name", "org_id"}
	roleColumnsWithoutDefault = []string{"name", "org_id"}
	roleColumnsWithDefault    = []string{"role_id"}
...
func (o *Role) Org(mods ...qm.QueryMod) orgQuery {
...
func (o *Role) Policies(mods ...qm.QueryMod) policyQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"role_policies\" on \"policy\".\"policy_id\" = \"role_policies\".\"policy_id\""),
		qm.Where("\"role_policies\".\"role_id\"=?", o.RoleID),
	)
...
func (o *Role) Users(mods ...qm.QueryMod) userQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"user_roles\" on \"user\".\"user_id\" = \"user_roles\".\"user_id\""),
		qm.Where("\"user_roles\".\"role_id\"=?", o.RoleID),
	)
...
func (roleL) LoadOrg(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
...
func (roleL) LoadPolicies(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
...
func (roleL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"user\".user_id, \"user\".name, \"user\".api_key, \"user\".org_id, \"a\".\"role_id\""),
		qm.From("\"user\""),
		qm.InnerJoin("\"user_roles\" as \"a\" on \"user\".\"user_id\" = \"a\".\"user_id\""),
		qm.WhereIn("\"a\".\"role_id\" in ?", args...),
	)
	if mods != nil {
		mods.Apply(query)
	...
	for results.Next() {
		...
		err = results.Scan(&one.UserID, &one.Name, &one.APIKey, &one.OrgID, &localJoinCol)
		if err != nil {
...
// SetOrg of the role to the related item.
// Sets o.R.Org to related.
// Adds o to related.R.Roles.
func (o *Role) SetOrg(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Org) error {
	var err error
	if insert {
	...
	values := []interface{}{related.OrgID, o.RoleID}
...
func (o *Role) AddPolicies(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Policy) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"role_policies\" (\"role_id\", \"policy_id\") values ($1, $2)"
		values := []interface{}{o.RoleID, rel.PolicyID}
...
// Sets o.R.Roles's Policies accordingly.
// Replaces o.R.Policies with related.
// Sets related.R.Roles's Policies accordingly.
func (o *Role) SetPolicies(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Policy) error {
	query := "delete from \"role_policies\" where \"role_id\" = $1"
	...
	removePoliciesFromRolesSlice(o, related)
	if o.R != nil {
		o.R.Policies = nil
	}
...
func (o *Role) RemovePolicies(ctx context.Context, exec boil.ContextExecutor, related ...*Policy) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"role_policies\" where \"role_id\" = $1 and \"policy_id\" in (%s)",
...
func removePoliciesFromRolesSlice(o *Role, related []*Policy) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
...
func (o *Role) AddUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	...
	for _, rel := range related {
		query := "insert into \"user_roles\" (\"role_id\", \"user_id\") values ($1, $2)"
		values := []interface{}{o.RoleID, rel.UserID}
...
func (o *Role) RemoveUsers(ctx context.Context, exec boil.ContextExecutor, related ...*User) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"user_roles\" where \"role_id\" = $1 and \"user_id\" in (%s)",
		strmangle.Placeholders(dialect.UseIndexPlaceholders, len(related), 2, 1),
	)
	values := []interface{}{o.RoleID}
	for _, rel := range related {
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, roleID int, selectCols ...string) (*Role, error) {
	roleObj := &Role{}
	...
	query := fmt.Sprintf(
		"select %s from \"role\" where \"role_id\"=$1", sel,
	)
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, roleID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"role\" where \"role_id\"=$1 limit 1)"
